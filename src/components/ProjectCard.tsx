...
export const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <motion.article
      className="group relative flex flex-col justify-between rounded-2xl border border-border-base bg-bg-surface overflow-hidden transition-all duration-200 hover:border-border-base hover:shadow-md"
      whileHover={{ y: -3 }}
